...
public class Parser {
	 ...
	 */
	public Parser(InputStream is, OutputStream log, OutputStream bin, String[] symbols, PTBlock[][] parseTable, int startNode, String sourceName) {
		...
		try {
			...
			System.err.println("Exception at scanner instantiation:");
		...
		try {
			...
			System.err.println("Exception at code generator instantiation:");
			System.err.println("\t"+e.getMessage());
		}
	}
	...
	public void parse() {
		try {
			...
			int currentNode = startNode;   // start node
